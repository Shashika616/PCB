...
const DesignerPage = () => {
    ...
    const getAllPCBs = async () => {
        try {
            const response = await axios.get("https://2bf3cacc-4d25-40ba-8fba-b400401187f5-prod.e1-us-east-azure.choreoapis.dev/pcb-management/pcb-service-3/v1.0/api/designers/pcbs", {
                headers : {
    ...
    const updateDesign = async () => {
        try {
            await axios.put(`https://2bf3cacc-4d25-40ba-8fba-b400401187f5-prod.e1-us-east-azure.choreoapis.dev/pcb-management/pcb-service-3/v1.0/api/designers/pcbs/${selectedPcbId}/design`, {design}, {
                headers : {
                    'Authorization' : `Bearer ${token.current}`,
                    'Content-Type': 'application/json'
                }
    ...
    const getDesign = async () => {
        try {
            const response = await axios.get(`https://2bf3cacc-4d25-40ba-8fba-b400401187f5-prod.e1-us-east-azure.choreoapis.dev/pcb-management/pcb-service-3/v1.0/api/designers/pcbs/${selectedPcbId}/design`, {
                headers : {
                    'Authorization' : `Bearer ${token.current}`,
                    'Content-Type': 'application/json'
                }
    ...
    const createNewPcb = async () => {
        try {
            const response = await axios.post("https://2bf3cacc-4d25-40ba-8fba-b400401187f5-prod.e1-us-east-azure.choreoapis.dev/pcb-management/pcb-service-3/v1.0/api/designers/pcbs", { modelName: newPcbModel }, {
                headers : {
                    'Authorization' : `Bearer ${token.current}`,
                    'Content-Type': 'application/json'
                }
